...
${OBJECTDIR}/src/Reader.o: src/Reader.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG_ -D_DEBUG_DETAIL -I../RWA-Lib/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Reader.o src/Reader.cpp

${OBJECTDIR}/src/Record.o: src/Record.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG_ -D_DEBUG_DETAIL -I../RWA-Lib/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Record.o src/Record.cpp
...
${OBJECTDIR}/src/recGMST.o: src/recGMST.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG_ -D_DEBUG_DETAIL -I../RWA-Lib/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/recGMST.o src/recGMST.cpp

${OBJECTDIR}/src/recKEYM.o: src/recKEYM.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG_ -D_DEBUG_DETAIL -I../RWA-Lib/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/recKEYM.o src/recKEYM.cpp

${OBJECTDIR}/src/recTES4.o: src/recTES4.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG_ -D_DEBUG_DETAIL -I../RWA-Lib/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/recTES4.o src/recTES4.cpp

${OBJECTDIR}/src/recWEAP.o: src/recWEAP.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG_ -D_DEBUG_DETAIL -I../RWA-Lib/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/recWEAP.o src/recWEAP.cpp
