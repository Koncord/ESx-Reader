...
LDLIBSOPTIONS=-L/F/SDK/gtest-bin/lib -L../dist/${CND_CONF}/${CND_PLATFORM} -lgtest_main -lgtest -lesx-reader -lz
...
${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -s -I/F/SDK/gtest-bin/include/ -I../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
